...
const LocationInfoSearchCard = forwardRef<
  HTMLDivElement,
  LocationInfoSearchCardProps
>(
  (
    { image, name, location, contentId, contentType, isSelected, onClick },
    ref
  ) => {
    ...
    return (
      <div className="flex items-center gap-4pxr w-full h-50pxr" ref={ref}>
...
LocationInfoSearchCard.displayName = "LocationInfoSearchCard";

export default LocationInfoSearchCard;
