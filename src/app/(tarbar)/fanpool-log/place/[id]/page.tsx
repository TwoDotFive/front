...
export default function TeamTravelogDetailPage() {
  ...
  return (
    <div>
      <TapBar text="새마을 전통시장" type="mid" isNextButton={false} />
      <Image
        src="/images/fanpool-log_ex.png"
        width={375}
        height={211}
                  ...
                  .map((key) => (
                    ...
                    >
                      <div className="flex items-center gap-4pxr">
                        ...
                        {menus[Number(key)].main && (
                          <TagLocation name="대표메뉴" />
                        )}
                      </div>
                      <Text fontSize={14} fontWeight={500} color="gray700">
                        {menus[Number(key)].price}원
                      </Text>
                    </div>
                  ))}
